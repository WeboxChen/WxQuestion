Ext.define('Wei.view.custom.UserAnswerGrid', {
    ...
    columns: [
        ...
        { xtype: 'datecolumn', text: '开始时间', dataIndex: 'begintime', format: 'Y-m-d H:i', hidden: false },
        { xtype: 'datecolumn', text: '完成时间', dataIndex: 'completedtime', format: 'Y-m-d H:i', hidden: false },
